...
describe('<CurrencyInput/> backspace', () => {
  ...
  it('should handle Del key without moving cursor', async () => {
    ...
    await userEvent.type(screen.getByRole('textbox'), '{arrowleft}{arrowleft}{arrowleft}{delete}')
  ...
  it('should handle backspace character when no prefix', async () => {
    ...
    await userEvent.type(input, '{arrowleft}{arrowleft}{arrowleft}{backspace}')
  ...
  it('should handle delete character left of group separator correctly', async () => {
    ...
    await userEvent.type(input, '{arrowleft}{arrowleft}{arrowleft}{arrowleft}{delete}')
